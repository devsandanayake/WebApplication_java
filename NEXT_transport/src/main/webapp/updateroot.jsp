 ...
 <!-- ----LOGIN---- -->
  ...
  <main>
    <section class="container wrapper">
      <h2 class="display-4 pt-3">Update Root</h2>
          <%
...
%>
          ...
          <table>
                <tr><td>Location_ID</td><td><input type="text" name="id" value="<%=id %>" readonly="readonly"></td></tr>
                <tr><td>Customer Location</td><td><input type="text" value="<%=n %>"  name="n" ></td></tr>
                <tr><td>Drop Location</td><td><input type="text" value="<%=ad %>"name="em" ></td></tr>
                <tr><td>Vehicle Type</td><td><input type="text" value="<%=email %>" name="ad" ></td></tr>
                <tr><td>Contact number</td><td><input type="text" value="<%=tp %>" name="tp" ></td></tr>
                <tr><td>Passenger</td><td><input type="text" value="<%=me %>" name="me" ></td></tr>
                 <tr><td>Customer_ID</td><td><input type="text" value="<%=cn %>" name="cn" ></td></tr>
